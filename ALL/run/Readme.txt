...
docker run -it --name php-fpm2 -p 9000:9000 -v d:/Develop/Projects/ALL/PHP/docker/php-fpm/php7.2.ini:/usr/local/etc/php/php.ini  -v d:/Develop/Projects/ALL/PHP/asrorz/:/var/www:cached  asrorz_php-fpm
...
docker run -it --name nginx3 -p 80:80 -p 443:443 -v d:/Develop/Projects/ALL/PHP/asrorz/:/var/www:cached -v d:/Develop/Projects/ALL/PHP/logger/nginx:/var/log/nginx -v d:/Develop/Projects/ALL/PHP/docker/nginx/nginx.conf:/etc/nginx/nginx.conf:ro -v d:/Develop/Projects/ALL/PHP/docker/nginx/sites:/etc/nginx/sites-available -v d:/Develop/Projects/ALL/PHP/docker/nginx/ssl:/etc/nginx/ssl asrorz_nginx
